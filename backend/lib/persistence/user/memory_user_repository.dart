/*
 ...
 Notes:
 - Stores users and pending registrations in process memory; data is lost
   when the process exits.
 - Tokens generated by `startRegistration` are short numeric values intended
   for manual testing and not cryptographically secure.
