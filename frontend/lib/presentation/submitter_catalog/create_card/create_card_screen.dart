...
class _CreateCardScreenState extends State<CreateCardScreen> {
  ...
  Widget _buildStepCard({
    required CreateCardState state,
    required bool busy,
    ...
    switch (state.stage) {
      ...
      case CreateCardStage.image:
      case CreateCardStage.error:
      case CreateCardStage.submitting:
        return _ImageForm(
          ...
          isError: state.stage == CreateCardStage.error,
        );
      case CreateCardStage.success:
...
class _FlowProgress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final step = switch (stage) {
      CreateCardStage.identity => 1,
      CreateCardStage.image => 2,
      CreateCardStage.submitting => 2,
      CreateCardStage.error => 2,
      CreateCardStage.success => 3,
    };
