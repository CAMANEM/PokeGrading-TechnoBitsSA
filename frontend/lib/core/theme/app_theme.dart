...
/// Clase que centraliza los temas de la aplicación.
class AppTheme {
  AppTheme._();
  ...
  /// Construye el [TextTheme] usando Google Fonts (Space Grotesk).
